...
package com.visural.wicket.examples.jsr303;
 ...
 */
@At(url="/jsr303")
public class Jsr303ExamplePage extends BasePage {

    public Jsr303ExamplePage() {
        add(new JsrForm("jsrForm"));
    }
    ...
    class JsrForm extends JSR303ValidatedForm<ModelBean> {
